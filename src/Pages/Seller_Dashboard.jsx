            ...
            <>
              ...
              <Box
                sx={{
                  ...
                  display: "flex",
                  flexDirection: { xs: "column", md: "row" },
                  justifyContent: "space-between", // Add space between items in larger screens
                }}
              >
                <Card
                  sx={{
                    width: { xs: "100%", md: "25%" }, // Full width on small screens, 25% on medium and larger
                    margin: { xs: "10px 0", md: "20px" }, // Adjust margin for small screens
                    backgroundColor: "#f5f5f5",
