...
const User_Profile = ({ onClose }) => {
  ...
  const handleSaveClick = () => {
    axios
      .put(`http://backend-rho-three-58.vercel.app/users/${id}`, updatedUser)
      .then((res) => {
        setUser(res.data);
        setIsEditing(false);
      })
...
const User_Profile = ({ onClose }) => {
  ...
  const handleSaveClick = () => {
    ...
    axios
      .put(`http://backend-rho-three-58.vercel.app/users/${id}`, combinedData)
      .then((res) => {
        setUser(res.data);
        setIsEditing(false);
      })
...
const User_Profile = ({ onClose }) => {
  ...
  //       axios
  //         .get(`http://backend-rho-three-58.vercel.app/get_user_address/${currentUser.uid}`)
  //         .then((res) => {
  ...
  useEffect(() => {
    ...
    if (updatedUser?.address_id) {
      ...
      axios
        .get(
          `http://backend-rho-three-58.vercel.app/get_user_address/${currentUser.uid}`
        )
        .then((res) => {
          console.log(res.data);
          setAddressup({
